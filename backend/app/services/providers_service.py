...
_DEFAULTS: list[dict] = [
    ...
    {
        "id": "llamacpp",
        "name": "llama.cpp (Local multi-GPU)",
        "description": "llama-server gestionado — Vulkan multi-GPU (tensor-split), Anthropic Messages API nativa",
        "api_base": "http://127.0.0.1:4002",
        "litellm_prefix": "openai",
        "auth_env_var": "",
        "models_endpoint": "http://127.0.0.1:4002/v1/models",
        "active_model": "local",
